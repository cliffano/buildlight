 ...
 */
BuildLight.prototype.blink = function (colour, cb) {
  if (!cb) {
    cb = colour;
    colour = null;
  }
  ...
  async.whilst(condition, task, cb);
};
 ...
 * @param {Function} cb: callback with error arg if there's any interruption
 */
BuildLight.prototype.unblink = function (cb) {
 ...
 * - platform: override platform value
 */
BuildLight.prototype._driver = function (opts) {
